...
namespace WPForms\Vendor\TijsVerkoyen\CssToInlineStyles;

use WPForms\Vendor\Symfony\Component\CssSelector\CssSelector;
use WPForms\Vendor\Symfony\Component\CssSelector\CssSelectorConverter;
use WPForms\Vendor\Symfony\Component\CssSelector\Exception\ExceptionInterface;
use WPForms\Vendor\TijsVerkoyen\CssToInlineStyles\Css\Processor;
use WPForms\Vendor\TijsVerkoyen\CssToInlineStyles\Css\Property\Processor as PropertyProcessor;
use WPForms\Vendor\TijsVerkoyen\CssToInlineStyles\Css\Rule\Processor as RuleProcessor;
class CssToInlineStyles
{
    private $cssConverter;
    public function __construct()
    {
        if (\class_exists('WPForms\\Vendor\\Symfony\\Component\\CssSelector\\CssSelectorConverter')) {
