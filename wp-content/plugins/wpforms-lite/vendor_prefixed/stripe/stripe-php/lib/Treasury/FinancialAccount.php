...
namespace WPForms\Vendor\Stripe\Treasury;
 ...
 */
class FinancialAccount extends \WPForms\Vendor\Stripe\ApiResource
{
    ...
    public function retrieveFeatures($params = null, $opts = null)
    {
        ...
        $obj = \WPForms\Vendor\Stripe\Util\Util::convertToStripeObject($response, $opts);
